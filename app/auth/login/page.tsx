...
import { AlertCircle, Mail, Lock, Eye, EyeOff, CheckCircle, Github, ArrowRight, Shield, Zap, Users, Briefcase } from "lucide-react"
          ...
          <div className="w-full lg:w-1/2 flex items-center justify-center p-8 lg:p-12">
            <div className="max-w-md w-full">
              ...
              {error && (
                <Alert
                  variant="destructive"
                  className="mb-6 border-red-200 bg-red-50 animate-in fade-in-50 duration-300 rounded-xl"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="pl-12 h-14 border-2 border-gray-200 focus:border-emerald-500 focus:ring-emerald-500 rounded-xl text-base font-medium transition-all duration-200"
                    />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="pl-12 pr-12 h-14 border-2 border-gray-200 focus:border-emerald-500 focus:ring-emerald-500 rounded-xl text-base font-medium transition-all duration-200"
                    />
                    <button
                      type="button"
                ...
                <Button
                  type="submit"
                  className="w-full h-14 bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-lg rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
                  disabled={isLoading}
                >
                  {isLoading ? (
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                <Button
                  ...
                  variant="outline"
                  className="h-14 border-2 border-gray-200 hover:border-emerald-300 hover:bg-emerald-50 rounded-xl font-semibold text-gray-700 transition-all duration-200 shadow-sm hover:shadow-md"
                  disabled={isLoading}
                >
                ...
                <Button
                  ...
                  variant="outline"
                  className="h-14 border-2 border-gray-200 hover:border-gray-400 hover:bg-gray-50 rounded-xl font-semibold text-gray-700 transition-all duration-200 shadow-sm hover:shadow-md"
                  disabled={isLoading}
                >
            ...
            <div className="absolute inset-0 flex flex-col justify-center items-center text-white p-12 text-center z-20">
              <div className="max-w-md">
                <div className="w-20 h-20 bg-white/20 rounded-3xl flex items-center justify-center mx-auto mb-8 backdrop-blur-sm">
                  <Briefcase className="w-10 h-10 text-white" /> {/* Swapped Zap for Briefcase */}
                </div>
