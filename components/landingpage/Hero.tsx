      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left space-y-8">
            {/* Trust Signal */}
            <div className="inline-flex items-center space-x-2 bg-card/80 backdrop-blur-sm rounded-full px-4 py-2 border border-primary/20">
              <div className="w-2 h-2 bg-primary rounded-full animate-pulse"></div>
              <span className="text-sm font-medium text-primary">Built in India, trusted by early users</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Link
                ...
                className="inline-flex items-center justify-center px-8 py-4 text-lg font-semibold text-primary-foreground bg-primary hover:bg-primary/90 rounded-lg transition-colors duration-200 shadow-lg hover:shadow-xl"
              ...
              <Link
                href="/view-gigs"
                className="inline-flex items-center justify-center px-8 py-4 text-lg font-semibold text-primary bg-card hover:bg-accent border-2 border-primary rounded-lg transition-colors duration-200"
            ...
            <div className="flex flex-row items-center justify-center lg:justify-start gap-2 xs:gap-3 sm:gap-4 md:gap-6 lg:gap-8 text-xs xs:text-sm sm:text-base text-muted-foreground overflow-x-auto scrollbar-hide">
              <div className="flex items-center space-x-1.5 xs:space-x-2 sm:space-x-3 flex-shrink-0">
                <svg className="w-3.5 h-3.5 xs:w-4 xs:h-4 sm:w-5 sm:h-5 text-primary flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                  <path
                    fillRule="evenodd"
          ...
          <div className="relative">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="font-semibold text-card-foreground">PostMyGig</span>
                  </div>
                ...
                <div className="bg-muted rounded-lg p-6 space-y-4">
                  ...
                  <div className="flex items-start justify-between">
                    <div className="space-y-2 flex-1">
                      <h3 className="text-xl font-bold text-foreground">Full Stack Ecommerce App</h3>
                      <p className="text-muted-foreground">Need an developer to build me an Ecommerce application.</p>
                    </div>
                    <div className="flex items-center space-x-2 bg-card rounded-full px-3 py-1 border border-border">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex flex-wrap gap-2">
                      <span className="px-3 py-1 text-sm font-medium text-primary bg-card border border-primary/20 rounded-full">
                        node
                      </span>
                      <span className="px-3 py-1 text-sm font-medium text-primary bg-card border border-primary/20 rounded-full">
                        react
                  ...
                  <div className="flex items-center justify-between pt-2">
                    ...
                    <button className="bg-primary text-primary-foreground px-4 py-2 rounded-lg text-sm font-medium hover:bg-primary/90 transition-colors flex items-center space-x-1">
                      <span>Open Gig</span>
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {/* Floating Elements */}
            <div className="absolute -top-4 -right-4 bg-primary/10 rounded-full p-3 shadow-lg">
              <svg className="w-6 h-6 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
              </svg>
            </div>
            <div className="absolute -bottom-4 -left-4 bg-primary/10 rounded-full p-3 shadow-lg">
              <svg className="w-6 h-6 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
